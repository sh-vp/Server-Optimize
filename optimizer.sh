...
echo -e "${red}=================================================${nc}"
echo -e ""
echo -e "${green}# Install Important Packages !${nc}"
echo -e "${green}# Set TimeZone !${nc}"
echo -e "${green}# Fix Hosts File !${nc}"
echo -e "${green}# Fix Dns Nameservers !${nc}"
echo -e "${green}# Block Local Ip's For Control Netscan Attack !${nc}"
echo -e "${green}# Enable BBR !${nc}"
echo -e ""
echo -e "${green}Server ${yellow}Optimized${green} Successfully!${nc}"
}
